...
const BlogPostDashboard = () => {
    ...
    const confirmDelete = async () => {
        try {
            ...
            setBlogs(blogs.filter(blog => blog._id !== selectedBlogId && blog.id !== selectedBlogId));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingId) {
                // Edit existing blog
                console.log("Editing blog with ID:", editingId);
    ...
    const handleToggleStatus = async (id, currentStatus) => {
        try {
            ...
            setBlogs(
                blogs
                    .map(blog => (blog._id === blogId || blog.id === blogId) ? { ...blog, status: !currentStatus } : blog)
                    .sort((a, b) => new Date(b.publishDate || b.createdAt) - new Date(a.publishDate || b.createdAt))
            );
        } catch (error) {
            ...
            <Table striped bordered hover>
                ...
                <tbody>
                    {currentBlogs.map((blog, index) => {
                        ...
                        // FIX: Use _id as primary identifier, fallback to id
                            ...
                            <tr key={blogId || index}>
                                ...
                                <td>
                                    <Form.Check
                                        ...
                                        onChange={() => handleToggleStatus(blogId, blog.status)}

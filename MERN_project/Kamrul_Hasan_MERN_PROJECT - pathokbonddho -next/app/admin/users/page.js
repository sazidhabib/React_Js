...
import { Container, Row, Col, Table, Button, Modal, Form, Badge, Spinner, Card } from 'react-bootstrap';
    ...
    return (
        <div className="container mt-4">
            ...
            <Modal show={modals.delete} onHide={() => setModals({ ...modals, delete: false })} centered>
                ...
                <Modal.Footer><Button variant="danger" onClick={() => handleAction('delete')} disabled={saving}>Delete</Button></Modal.Footer>
            </Modal>
        </div>
    );
};

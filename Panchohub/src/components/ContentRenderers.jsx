...
export const DoctorContent = ({ item, onShowChambers, onClick }) => (
  <>
    <div
...
export const ShoppingContent = ({ item, onClick }) => (
  <>
    <div
      className="border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer"
      onClick={onClick}
...
export const VehicleRentContent = ({ item, onClick }) => (
  <>
    <div
      className="border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer"
      onClick={onClick}
...
export const TeachersContent = ({ item, onClick }) => (
  <>
    <div
      className="border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer"
      onClick={onClick}
    >
      ...
      <div className="space-y-2 text-sm text-left">
        ...
        {item.name && (
          <p>
            <strong>শিক্ষকের নাম: </strong>
            {item.name}
          </p>
        )}
        {item.classess && (
          <p>
            <strong>শ্রেণীর: </strong>
            {item.classess}
          </p>
        )}
        {item.subjects && (
          <p>
            <strong>সাবজেক্ট: </strong>
            {item.subjects}
          </p>
        )}
        {item.time_period && (
          <p>
            <strong>দিন সমূহ: </strong>
            {item.time_period}
          </p>
        )}
        {item.gender && (
  ...
  <>
    ...
    <div className="space-y-2 text-sm text-left">
      ...
      {item.email && (
        <p>
          <strong>
            {slug === "entrepreneurs" ? "ইমেইল: " : "প্রতিষ্ঠানের ইমেইল: "}
          </strong>
          {item.email}
        </p>
      )}
      ...
      {item.page_link && (
        <p>
          <strong>পদের নাম: </strong>
          <a className="text-blue-600" href={item.page_link} target="_blank">
            {item.page_link}
          </a>
        </p>
      )}

      ...
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-md overflow-hidden p-8">
        ...
        <div className="prose prose-lg max-w-none mb-8">
          <p className="text-gray-700 mb-6">
            Users can delete their accounts at any time from within the app by
            going to:
          </p>
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
            ...
            <p className="font-medium text-gray-800">
              প্রোফাইল → সেটিংস → ডিলিট অ্যাকাউন্ট।
            </p>
          </div>
          ...
          <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
            ...
            <p className="text-gray-700">
              If you are unable to access the app, you may request deletion by
              contacting us at:
            </p>
            <a

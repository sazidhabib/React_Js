        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-6 items-start self-start mt-6">
            ...
            <a href="#" aria-label="Twitter">
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/6727711e709c43036ee17b07f05fe765bec4c39b4f8d89710b66d6aa72adb5ff?placeholderIfAbsent=true&apiKey=f40e85373ac14970bb43d76751298eef"
                alt=""
                className="object-contain shrink-0 w-6 aspect-square"
              />
            </a>
      ...
      <div className="flex flex-col items-center mt-16 w-full max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex gap-3 items-center mt-4 text-base text-white">
          <div className="flex gap-1.5 items-center self-stretch my-auto min-w-[240px]">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/c9255197fb7f6a68bdb5f4b54de482f531f124b2e217b117b3b0e4deba8cd4a3?placeholderIfAbsent=true&apiKey=f40e85373ac14970bb43d76751298eef"
              alt=""

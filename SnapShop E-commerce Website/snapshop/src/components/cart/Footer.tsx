        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-6 items-start self-start mt-6">
            ...
            <a href="#" aria-label="Twitter">
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/85415e0550eeb33bbc0606f48b0af4c542585110414ead246440b2cd3b2f9e04?placeholderIfAbsent=true&apiKey=f40e85373ac14970bb43d76751298eef"
                alt=""
                className="object-contain shrink-0 w-6 aspect-square"
              />
            </a>

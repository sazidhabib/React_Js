                ...
                <div class="product-description">
                    <div class="body-area">
                     ...
                     <form id="geniusformdata" action="{{ route('rss.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            @endphp
                            <input type="hidden" name="language_id" id="rss_language_id" value="{{ $default_language->id }}">
...
(function($) {
    ...
    $(document).ready(function() {
        ...
        var languageId = $('#rss_language_id').val();
        
        if (languageId) {
            // Use named route instead of hardcoded URL
            var url = "{{ url('/') }}/admin/rss/category/" + languageId;

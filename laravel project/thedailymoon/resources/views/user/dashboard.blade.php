    ...
    <div class="row row-cards-one">
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg1">
                <div class="left">
                    <h5 class="title">{{ __('Article Posts') }} </h5>
                        <span class="number">{{ $articles }}</span>
                    <a href="{{ route('user.post.index') }}" class="link">{{ __('View All') }}</a>
                </div>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg2">
                <div class="left">
                    <h5 class="title">{{ __('Audio Posts') }}</h5>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg3">
                <div class="left">
                    <h5 class="title">{{ __('Video Posts') }}</h5>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg4">
                <div class="left">
                    <h5 class="title">{{ __('Personality Quiz') }}</h5>
                        <span class="number">{{ $personalites }}</span>
                    <a href="{{ route('user.post.index') }}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg3">
                <div class="left">
                    <h5 class="title">{{ __('Trivia Quiz') }}</h5>
                    <span class="number">{{ $trivias }}</span>
                    <a href="{{ route('user.post.index') }}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg1">
                <div class="left">
                    <h5 class="title">{{ __('Sorted List') }} </h5>
                        <span class="number">{{ $sorted }}</span>
                    <a href="{{ route('user.post.index') }}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">

					...
					<div class="container-fluid">
						<div class="d-flex justify-content-between align-self-center">
							<a class="admin-logo" href="{{ route('admin.dashboard') }}">
								<img src="{{$gs->logo ? asset('assets/images/logo/'.$gs->logo) : asset('assets/front/images/logo.png')}}" alt="Logo" max-width="222" max-height="68">
							</a>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						...
						<div style="text-align: center; margin-bottom: 10px;">
						    <h5 style="font-size: 14px; color: #000; font-weight: bolder;"><a href="https://www.facebook.com/NextDigitOfficial/" target="_blank">নেক্সট ডিজিট </a> </h5>
						   <img src="{{asset('assets/images/Next-Digit.jpg')}}" alt="Next Digit" width="130" height="130"> 
						 </div>
					</nav>

...
<li>
    ...
    <ul class="collapse list-unstyled" id="page" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('admin.page.index') }}"><span><i class="fas fa-angle-double-right"></i>{{ __('All Pages') }}</span></a>
        </li>
    </ul>
</li>
...
<li>
    <a href="#menu2" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="fa fa-tag"></i>{{ __('Categories') }}
    </a>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="menu4" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('post.index') }}"><span><i class="fas fa-folder-open"></i>{{ __('All Posts') }}</span></a>
        </li>

        <li>
            <a href="{{ route('schedule.index') }}"><span><i class="fa fa-calendar" aria-hidden="true"></i>{{ __('Schedule Posts') }}</span></a>
        </li>

        <li>
            <a href="{{ route('pending.index') }}"><span><i class="fas fa-spinner"></i>{{ __('Pending Posts') }}</span></a>
        </li>

        <li>
            <a href="{{ route('draft.index') }}"><span><i class="fab fa-firstdraft"></i>{{ __('Drafts Posts') }}</span></a>
        </li>

        <li>
            <a href="{{ route('audio.index') }}"><span><i class="fas fa-volume-up"></i>{{ __('Audio Posts') }}</span></a>
        </li>

        <li>
            <a href="{{ route('video.index') }}"><span><i class="fas fa-film"></i>{{ __('Video Posts') }}</span></a>
        </li>
...
<li>
    <a href="{{ route('image.album.index') }}" >
        <i class="fas fa-image"></i>{{ __('Photo Gallery') }}
    </a>
</li>
...
<li>
    <a href="https://m.me/official.creativedesign" target="_blank"><span><i class="fab fa-facebook-messenger"></i>Live Support on facebook</span></a>
</li>

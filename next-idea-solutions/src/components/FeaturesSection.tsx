...
const features = [
  {
    ...
    description:
      "Let machines handle what machines do best while you focus on strategy and innovation.",
  },
  {
    icon: BarChart3,
    title: "Real-time analytics that move fast",
    description:
      "See what matters the moment it happens, not after the fact. Make decisions at the speed of data.",
  },
  {
    icon: Puzzle,
    title: "Seamless integration with your stack",
    description:
      "Connect to what you already use. No rip and replace. No headaches. Just pure productivity.",
  },
  {
    icon: Zap,
    title: "Lightning-fast performance",
    description:
      "Built for speed from the ground up. Experience sub-millisecond response times.",
  },
  {
    icon: Shield,
...
const FeaturesSection = () => {
  return (
    <section
      id="services"
      className="relative pt-2 pb-24 md:pb-32 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <p className="max-w-2xl mx-auto text-muted-foreground text-lg">
            We built our platform on three pillars that matter. Speed without
            compromise. Intelligence that learns. Integration that just works.
          </p>
        </div>

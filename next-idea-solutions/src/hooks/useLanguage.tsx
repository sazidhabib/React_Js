...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "features.security.description":
      "Bank-level encryption and compliance. Your data stays yours, always protected.",
    "features.global.title": "Global scale, local speed",
    "features.global.description":
      "Deploy anywhere in the world with edge computing. Your users get local performance, globally.",
  ...
  bn: {
    ...
    "features.ai.title": "আপনার মূলে AI অটোমেশন",
    "features.ai.description":
      "মেশিনকে তার কাজ করতে দিন যখন আপনি কৌশল এবং উদ্ভাবনে মনোযোগ দিন।",
    "features.analytics.title": "দ্রুত গতির রিয়েল-টাইম অ্যানালিটিক্স",
    "features.analytics.description":
      "যা গুরুত্বপূর্ণ তা ঘটার মুহূর্তে দেখুন। ডেটার গতিতে সিদ্ধান্ত নিন।",
    "features.integration.title":
      "আপনার স্ট্যাকের সাথে নিরবচ্ছিন্ন ইন্টিগ্রেশন",
    "features.integration.description":
      "আপনি ইতিমধ্যে যা ব্যবহার করছেন তার সাথে সংযোগ করুন। কোনো ঝামেলা নেই। শুধু বিশুদ্ধ উৎপাদনশীলতা।",
    "features.performance.title": "বিদ্যুৎ-দ্রুত পারফরম্যান্স",
    "features.performance.description":
      "শুরু থেকেই গতির জন্য তৈরি। সাব-মিলিসেকেন্ড রেসপন্স টাইম অনুভব করুন।",
    "features.security.title": "এন্টারপ্রাইজ-গ্রেড নিরাপত্তা",
    "features.security.description":
      "ব্যাংক-স্তরের এনক্রিপশন এবং কমপ্লায়েন্স। আপনার ডেটা সবসময় সুরক্ষিত।",
    "features.global.title": "বিশ্বব্যাপী স্কেল, স্থানীয় গতি",
    "features.global.description":
      "এজ কম্পিউটিং দিয়ে বিশ্বের যেকোনো জায়গায় ডিপ্লয় করুন।",
